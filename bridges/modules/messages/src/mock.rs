...
/// Regular message payload.
pub const SUCCESS_WOODPRODUCT_PAYLOAD: TestPayload = message_payload(0, 50);
/// Regular message payload.
pub const LENGTH_OVERLOAD_PAYLOAD: TestPayload = message_payload(0, 50);

pub const SUCCES_WOODPRODUCT_RESPONSE: TestPayload = message_payload(0, 50);

pub const ERROR_WOODPRODUCT_RESPONSE: TestPayload = message_payload(0, 50);

pub const PARACHAIN_ID:u32 = 1002;
