...
parameter_types! {              
    pub const MaxPayloadSize: u32 = u32::MAX; 
	pub const MaxProductOwned: u32 = 9999; 
    }
...
impl recycle_wood::Config for Runtime {
	...
	type RuntimeCall = RuntimeCall;
	type XcmSender = XcmRouter;
    type WoodProductRandomness = RandomnessCollectiveFlip;
	type MaxPayloadSize = MaxPayloadSize; 
	type MaxProductOwned = MaxProductOwned; 
